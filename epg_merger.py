...
CHANNELS = {
    ...
    "Animal Planet HD": ("animal-planet-hd-284", "onet", "AnimalPlanet.pl"),
    ...
    "Discovery Channel": ("discovery-channel-hd-67", "onet", "DiscoveryChannel.pl"),
    ...
    "Erox HD": ("erox-hd-520", "onet", "EroxHD.pl"),
    "Eroxxx HD": ("eroxxx-hd-512", "onet", "EroxxxHD.pl"),
    ...
    "FILMBOX+ Comedy": ("filmbox-family-103", "onet", "FilmBoxFamily.pl"),
    "FILMBOX+ Emotion": ("filmbox-extra-hd-86", "onet", "FilmBoxExtraHD.pl"),
    "FILMBOX+ Festival HD": ("filmbox-arthouse-hd-190", "onet", "FilmBoxArthouseHD.pl"),
    "FILMBOX+ Hits": ("filmbox-premium-85", "onet", "FilmBoxPremiumHD.pl"),
    "FILMBOX+ One HD": ("kino-tv-hd-663", "onet", "KinoTVHD.pl"),
    # ----------------------------
    ...
    "History HD": ("history-hd-92", "onet", "HISTORYHD.pl"),
    "History 2 HD": ("h2-hd-205", "onet", "History2.pl"),
    ...
    "Kabaret TV": ("kabaret-tv", "onet", "KabaretTV.pl"),
    ...
    "Polsat Cafe HD": ("polsat-caf-hd-219", "onet", "PolsatCaféHD.pl"),
    ...
    "Polsat Sport Premium": ("polsat-sport-hd-96", "onet", "PolsatSport1HD.pl"),
    "Polsat Sport Extra": ("polsat-sport-extra-hd-144", "onet", "PolsatSport2HD.pl"),
    "Polsat Sport News": ("polsat-sport-news-hd-543", "onet", "PolsatSport3HD.pl"),
    ...
    "Tele 5 HD": ("tele-5-hd-147", "onet", "Tele5.pl"),
    ...
    "TravelXP 4K": ("travelxp-4k-659", "onet", "TravelxpHD.pl"),
    "TTV HD": ("ttv-33", "onet", "TTVHD.pl"),
    "TV4 HD": ("tv-4-hd-222", "onet", "TV4.pl"),
    "TV6 HD": ("tv-6-hd-561", "onet", "TV6.pl"),
    ...
    "Viasat Epic Drama HD": ("epic-drama-hd-603", "onet", "EpicDramaHD.pl"),
    ...
    # --- DODATKOWE WERSJE KANAŁÓW BEZ HD (Wyszukiwanie kompatybilności dla .m3u) ---
    "TVN": ("tvn-357", "onet", "TVN.pl"),
    "TVN 7": ("tvn-7-326", "onet", "TVN7.pl"),
    "TVN 24": ("tvn-24-347", "onet", "TVN24.pl"),
    "TV4": ("tv-4-360", "onet", "TV4_SD.pl"),
    "TV6": ("tv-6-429", "onet", "TV6_SD.pl"),
    "TTV": ("ttv-624", "onet", "TTV_SD.pl"),
    "Puls 2": ("puls-2-439", "onet", "Puls2_SD.pl"),
    "TV Puls": ("tv-puls-332", "onet", "TVPuls_SD.pl"),
    "Polsat": ("polsat-38", "onet", "Polsat_SD.pl"),

    # --- ZEWNĘTRZNE ŹRÓDŁA XML (FALLBACK) ---
...
if __name__ == "__main__":
    if "--auto" in sys.argv:
        ...
        m.run(selected_days=[-3, -2, -1, 0, 1, 2, 3, 12], detailed_days=[-3, -2, -1, 0, 1, 2, 3, 12])
        m.save()
    else:
        start_gui()